...
case $(echo -e "Restic Backup\nRestic Forget\nRestic Snapshots\nRestic Prune\nDrive Push" | rofi -dmenu -i -lines 5 -p "Last Backup: $date") in
	Restic\ Backup)
		...
		output=$(rofi -dmenu -password -lines 0 -p "Password" | restic backup --exclude-file=/home/coffeevector/Backup/resticExclusions -r /home/coffeevector/Backup/resticBackup /home/coffeevector | (head -n 1 | awk '{print $4}'; tail -n 1 | awk '{print $2}'))
		if [ "$output" = "" ]; then
		...
		rofi -dmenu -password -lines 0 -p "Password" | restic diff -r /home/coffeevector/Backup/resticBackup $output | head -n -8 | tail -n +2 > /home/coffeevector/Backup/resticDiff
		if [ -s "/home/coffeevector/Backup/resticDiff" ]; then
			cat /home/coffeevector/Backup/resticDiff | dirtree -o /home/coffeevector/Backup/resticDiff.html
			cat /home/coffeevector/Backup/resticDiff | dirtree -t treemap -o /home/coffeevector/Backup/resticDiffTreemap.html
			google-chrome /home/coffeevector/Backup/resticDiff.html
			google-chrome /home/coffeevector/Backup/resticDiffTreemap.html
		else 
			notify-send.sh -r $notifyID "RESTIC DIFF PASSWORD FAILED"
		fi
		mv /home/coffeevector/Backup/resticDiff /home/coffeevector/Backup/resticDiff.bak
		;;
	Restic\ Forget)
